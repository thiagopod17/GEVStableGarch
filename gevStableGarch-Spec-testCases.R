...
# General Testing
spec <- GSgarchSpec(model = list(), presample = a,cond.dist = ,rseed = NULL)
spec <- GSgarchSpec(model = list(delta = 2), presample = a,cond.dist = ,rseed = NULL)
spec <- GSgarchSpec(model = list(delta = 2), presample = NULL,cond.dist = ,rseed = NULL) 
spec <- GSgarchSpec(model = list(ar = 1, delta = 2),cond.dist = ,rseed = NULL)  

# Testing the FORMULA (garch, arma, arch, etc)
spec <- GSgarchSpec(model = list(ar = 1, alpha = 4, beta = 3, delta = 2), presample = NULL,cond.dist = ,rseed = NULL)   
spec <- GSgarchSpec(model = list(ar = 1, alpha = -4, beta = 3, delta = 2), 
presample = NULL,cond.dist = ,rseed = NULL)    
spec <- GSgarchSpec(model = list(ar = 1, alpha = 4, beta = 3, delta = 2), 
presample = NULL,cond.dist = NULL,rseed = NULL)      
spec <- GSgarchSpec(model = list(mu = 3,ar = 1, alpha = 4, beta = 3, delta = 2), 
presample = NULL,cond.dist = c("norm"),rseed = 3)
# ARMA(1,1)
spec <- GSgarchSpec(model = list(mu = 3,ar = 1, ma = 4), 
presample = NULL,cond.dist = c("norm"),rseed = 3)         
# ARMA(1,1)-ARCH(1)
spec <- GSgarchSpec(model = list(mu = 3,ar = 1, ma = 4,alpha = 3,delta = 2), 
presample = NULL,cond.dist = c("norm"),rseed = 3)   
# AR(2)-ARCH(1)
spec <- GSgarchSpec(model = list(mu = 3,ar = c(1,2),alpha = 3,delta = 2), 
presample = NULL,cond.dist = c("norm"),rseed = 3)       
# MA(2)-ARCH(1)
spec <- GSgarchSpec(model = list(mu = 3,ma = c(1,2),alpha = 3,delta = 2), 
presample = NULL,cond.dist = c("norm"),rseed = 3)     
# MA(2)-APARCH(1)
spec <- GSgarchSpec(model = list(mu = 3,ma = c(1,2),alpha = 3,delta = 1), 
presample = NULL,cond.dist = c("norm"),rseed = 3)
# MA(2)-APARCH(0,1): expect error because alpha was not specified.
spec <- GSgarchSpec(model = list(mu = 3,ma = c(1,2),beta = 3,delta = 1), 
presample = NULL,cond.dist = c("norm"),rseed = 3)    
# MA(2)-APARCH(1,1)
spec <- GSgarchSpec(model = list(mu = 3,ma = c(1,2),alpha = 3,beta = 3,delta = 1), 
presample = NULL,cond.dist = c("norm"),rseed = 3)  
# MA(2)-APARCH(2,1)
spec <- GSgarchSpec(model = list(mu = 3,ma = c(1,2),alpha = c(3,3),
...
presample = NULL,cond.dist = c("norm"),rseed = 3)
# AR(2)-GARCH(2,1)
spec <- GSgarchSpec(model = list(mu = 3,ar = c(1,2),alpha = c(3,3),
gamma = c(0,0),beta = 3,delta = 2), 
presample = NULL,cond.dist = c("norm"),rseed = 3)
# AR(2)-APARCH(2,1)
spec <- GSgarchSpec(model = list(mu = 3,ar = c(1,2),alpha = c(3,3),
...
spec <- GSgarchSpec(model = list(alpha = c(3,3,3), delta = 0.4), 
presample = NULL,cond.dist = c("gev"),rseed = 3)   
spec <- GSgarchSpec(model = list(alpha = c(0.99), delta = 0.4), 
...
spec <- GSgarchSpec(model = list(alpha = c(0.4,4), delta = 0.4), 
presample = pre, cond.dist = c("gev"),rseed = 4)
# exact presample size. OK
pre <- matrix(4,nrow = 1,ncol = 3)
spec <- GSgarchSpec(model = list(alpha = c(0.4), delta = 0.4), 
presample = pre, cond.dist = c("gev"),rseed = 4)
